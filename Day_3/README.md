...
* `r < len(grid) - 1` : minus 1 because index starts from 0, the alternative is r + 1
* `grid[r][c % len(grid[r])]` : wraps grid, ex: 5 columns, at 7th, 7%5 = 2

## References / Resources

This problem was about grid navigation
